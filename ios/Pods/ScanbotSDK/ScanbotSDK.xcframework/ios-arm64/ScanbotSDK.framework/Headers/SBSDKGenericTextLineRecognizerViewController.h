 ...
 */
- (nullable instancetype)initWithConfiguration:(nullable SBSDKGenericTextLineRecognizerConfiguration *)configuration
                                      delegate:(nullable id<SBSDKGenericTextLineRecognizerViewControllerDelegate>)delegate;
