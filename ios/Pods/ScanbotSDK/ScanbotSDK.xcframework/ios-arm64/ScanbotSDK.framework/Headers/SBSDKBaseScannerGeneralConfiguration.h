...
#import "SBSDKVideoFrameResolution.h"
 ...
 * Defaults to 'SBSDKVideoFrameResolutionAuto'. 
 ...
 * It is therefore recommended to keep this setting at `SBSDKVideoFrameResolutionAuto`.
 */
@property (nonatomic, assign) SBSDKVideoFrameResolution videoFrameResolution;
...
/**
 * To prevent blurred images before the video frame is sent to the detector, the device must have registered
 * no significant motion for a certain amount of time. This property defines this amount of time. 
 * By default it is set to 0.0 seconds for the most scanners.
 */
@property (atomic, assign) NSTimeInterval minimumTimeWithoutDeviceMotionBeforeDetection;
