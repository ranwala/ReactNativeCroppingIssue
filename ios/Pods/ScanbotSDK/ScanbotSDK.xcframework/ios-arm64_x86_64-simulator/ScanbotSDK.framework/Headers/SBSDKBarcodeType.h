...
+ (NSArray<SBSDKBarcodeType*>*)oneDTypes;

/** Returns an array containing all 2-D barcode types */
+ (NSArray<SBSDKBarcodeType*>*)twoDTypes;
...
extern SBSDKBarcodeType * const SBSDKBarcodeTypeCode25;
...
extern SBSDKBarcodeType * const SBSDKBarcodeTypeIATA2Of5;

/** The barcode type INDUSTRIAL_2_OF_5. */
extern SBSDKBarcodeType * const SBSDKBarcodeTypeIndustrial2Of5;
