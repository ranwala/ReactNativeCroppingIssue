//
//  SBSDKUIFinderDocumentScannerBehaviorConfiguration.h
//  SBSDK Internal Demo
//
...
/**
 * If set to YES, allows only scanning of documents with the aspect ratio that the finder has set.
 * The default value is NO.
 */
@property (nonatomic, assign) BOOL lockDocumentAspectRatioToFinder;
