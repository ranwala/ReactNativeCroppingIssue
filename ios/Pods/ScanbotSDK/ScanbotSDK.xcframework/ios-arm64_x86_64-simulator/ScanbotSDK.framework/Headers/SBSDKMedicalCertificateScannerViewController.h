 ...
 * @param controller The medical scanner view controller which recognized the medical certificate.
 ...
 * @param controller The medical scanner view controller that will receive the video frame.
 ...
 * @param controller The medical scanner view controller that changed its state.
...
/**
 * Classic UI view controller that can be used to detect and recognize medical certificates. Can be configured to
...
@property(nullable, nonatomic, weak) id<SBSDKMedicalCertificateScannerViewControllerDelegate>delegate;
...
- (nullable instancetype)initWithParentViewController:(nonnull UIViewController *)parentViewController
                                           parentView:(nonnull UIView *)parentView
                                             delegate:(nullable id<SBSDKMedicalCertificateScannerViewControllerDelegate>)delegate;
