...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ScanbotSDK/ALL/ScanbotSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ScanbotSDKNativeWrapper/ALL/ScanbotSDKNativeWrapper.framework"
